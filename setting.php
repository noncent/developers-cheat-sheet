...
/**
 * Increase Curl/HTTP timeout for Command line request
 * HTTP Client config.
 *
...
$settings['hash_salt'] = 'af5a5a5a5a5a5fs5f5v5x5caf5a5a5a5a5a5fs5f5v5x5caf5a5a5a5a5a5fs5f5v5x5c';
...
// S3FS setting: This section configures the S3FS module to integrate with Amazon S3.

// Specify the name of the S3 bucket to use for file storage.
$config['s3fs.settings']['bucket'] = 'sync-source';
...
// Use S3 for storing private files.
// If set to true, private files will be stored in the specified S3 bucket.
$settings['s3fs.use_s3_for_private'] = true;
// Use S3 for storing public files.
// If set to true, public files will be stored in the specified S3 bucket.
$settings['s3fs.use_s3_for_public'] = true;

$settings['reverse_proxy'] = true;
$settings['reverse_proxy_addresses'] = array($_SERVER['REMOTE_ADDR']);
$settings['trusted_host_patterns'] = ['^staging\.site\.com$'];
$settings['cache_ttl_4xx'] = 1;

if (isset($_SERVER['HTTP_X_FORWARDED_FOR'])) {
    $conf['cache_page_external_http'] = true;
}

$settings['config_sync_directory'] = 'config';

# Changing PHP twig storage path
$settings['php_storage']['twig']['directory'] = '../twig/storage/php';
